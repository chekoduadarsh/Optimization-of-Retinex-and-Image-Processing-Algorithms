...
void ssr_thread(int id)
{
	...
	while (true)
	{
		...
		for (int i = 0; i < height; ++i)
		{
			...
			x = logg[img.at<Vec3b>(i, j)[2]] /logg[gauss.at<Vec3b>(i, j)[2]];
			
			z = logg[img.at<Vec3b>(i, j)[0]] /logg[gauss.at<Vec3b>(i, j)[0]];
			
			y = (logg[img.at<Vec3b>(i, j)[1]] /logg[gauss.at<Vec3b>(i, j)[1]]);
